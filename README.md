...
_Please describe at a high level what this program is designed to do when used. Your target audience is other scientists and your goal is to tell them just enough information to decide whether they want to use this software for their own research. Aim for 3 - 4 sentences at most._
...
_Please provide a soft link to your License.txt file, [License](LICENSE.txt). If you do not know what license to use please talk to the tech core, we can provide recommendations._
